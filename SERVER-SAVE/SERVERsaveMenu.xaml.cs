...
namespace KeepIT
{
    public partial class SERVERsaveMenu : Window
    {
        ...
        private void SERVERsaveMenu_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void btn_PovuciServerSave_Click(object sender, RoutedEventArgs e)
        {
        }
        ...
        private void btn_ServerPull_Click(object sender, RoutedEventArgs e)
        {
            SetModePull();
        }

        private void btn_ServerSave_Click(object sender, RoutedEventArgs e)
        {
            SetModeBrowse();
        }
    }
